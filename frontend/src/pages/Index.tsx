    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in-up">
            <h2 className="text-3xl md:text-4xl font-playfair font-bold">About Trishta</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Trishta is the first comprehensive tourist safety platform designed specifically 
      ...
      <footer className="bg-primary text-primary-foreground py-8">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; Making Northeast India tourism safer for everyone.</p>
        </div>
      </footer>
    </div>
  );
